                ...
                child: NestedScrollView(
                                ...
                                child: GestureDetector(
                                  ...
                                  onTap: () {
                                    Get.toNamed(
                                      ...
                                      arguments: {
                                        'imageList': con.productDetailModel
                                            .value.inventoryImages,
                                        "name": con.productName.value
                                      },
                                    );
                                  },
                                  child: Stack(
                                          ...
                                          return AppIconButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              await WishlistRepository
                                                  .createWishlistAPI(
                                                productListType:
                                                    con.productsListTypeType,
                                                inventoryId:
                                                    con.inventoryId.value,
                                                isWishlist: con.isLike.value,
                                              );
                                            },
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    AppButton(
                                      ...
                                      onPressed: () {
                                        PriceBreakupDialog.priceBreakupDialog(
                                            context,
                                            priceBreakModel: con
                                                    .productDetailModel
                                                    .value
                                      ...
                                      onPressed: () {
                                        Get.toNamed(
                                          ...
                                          arguments: {
                                            ...
                                            'sizeId': con.productDetailModel
                                                .value.sizeId,
                                            'metalId': con.productDetailModel
                                                .value.metalId,
                                            'diamondClarity': (con
                                                            .productDetailModel
                                                            .value
                                                ...
                                                ? con
                                                    ...
                                                    ?.value
                                                : "",
                                            "diamond": con.productDetailModel
                                                .value.diamonds,
                                            "isMultiDiamond": con
                                                .isMultipleDiamondSelection
                                                .value,
                                          },
                                        );
                                      },
                                    ...
                                    CustomProductWatchButton(
                                      ...
                                      onPressed: () {
                                        AppDialogs.addMetalDialog(
                                          context,
                                          metalWeight: con.productDetailModel
                                              .value.extraMetalWeight,
                                          metalPrice: con
                                                  .productDetailModel
                                                  .value
                                                  .priceBreaking
                  ...
                  body: TabBarView(
                    children: [
                      /// PRODUCT INFO TAB
                      ProductInfoTab(
                          infoList: con.productDetailModel.value.productInfo
                                  ?.toJson()
                                  .entries
                                  .toList() ??
                              []),
                      ...
                      FamilyProductTab(
                        productList:
                            con.productDetailModel.value.familyProducts ?? [],
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(
                            color: AppColors.textFiledBorder, width: 1),
                        borderRadius: BorderRadius.vertical(
                ...
                children: [
                  ...
                  if (!isValEmpty(con.productDetailModel.value.sizeId))
                    horizontalSelectorButton(
                      ...
                      sizeColorSelectorButtonType:
                          SizeMetalSelectorButtonType.small,
                  ...
                  horizontalSelectorButton(
                    ...
                    diamondsList:
                        RxList(con.productDetailModel.value.diamonds ?? []),
