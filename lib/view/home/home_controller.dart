...
class HomeController extends GetxController {
  ...
  List<Map<String, dynamic>> brandList = [
    ...
    {
      "image": 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4MJT-OT0a1HXFBgWaKIDyV0-eU-n-qXLhTw&s',
      "brandName": "Krishna",
    },
    {
      "image": 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQers3oGbMq-Ij2sssFAisAOD5r5j7N5c5yQw&s',
      "brandName": "Kala Mandir",
    },
    {
