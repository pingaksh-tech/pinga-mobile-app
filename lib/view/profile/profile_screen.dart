                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(image: NetworkImage(con.userDetails.value.data?.user?.image ?? ""), fit: BoxFit.fill),
                          ),
                        ),
                        // Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            "${con.userDetails.value.data?.user?.firstName ?? ""}  ${con.userDetails.value.data?.user?.lastName ?? ""}",
                        ...
                        Padding(
                          padding: EdgeInsets.only(top: defaultPadding / 2),
                          child: Text(
                            con.userDetails.value.data?.user?.mobileNo ?? "",
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              index == 0 ? "${con.userDetails.value.data?.totalCart ?? ""}" : "${con.userDetails.value.data?.totalOrder ?? ""}",
                              style: Theme.of(context).textTheme.titleMedium?.copyWith(fontSize: 27, fontWeight: FontWeight.w600),
                            ),
                          ),
                          Text(index == 0 ? "Total Cart Items" : "Total Orders", style: Theme.of(context).textTheme.titleMedium?.copyWith(fontSize: 12.sp, fontWeight: FontWeight.w500)),
                        ],
                      ),
                    ),
                  ),
