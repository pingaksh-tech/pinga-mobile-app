                        ...
                        children: [
                          UiUtils.fadeSwitcherWidget(
                            child: Text(
                              switch (con.screenType.value) {
                                ...
                                AuthScreenType.otpVerification =>
                              ...
                              child: switch (con.screenType.value) {
                                ...
                                AuthScreenType.otpVerification => RichText(
                                    ...
                                    text: TextSpan(
                                      ...
                                      style:
                                          AppTextStyle.subtitleStyle(context),
                                      children: [
                                        TextSpan(
                                          text:
                                              "${con.countryObject.value.dialCode} ${con.numberCon.value.text.trim()}",
                                          recognizer: TapGestureRecognizer()
                                            ..onTap = con.isLoading.isFalse &&
                                                    con.isResendOtp.isFalse
                                                ? () {
                                                    con.screenType.value =
                          ...
                          AnimatedClipRect(
                            ...
                            child: AppTextField(
                              ...
                              scrollPadding: UiUtils.textFieldScrollPadding(
                                  context,
                                  showError: con.numberValidation.value),
                                ...
                                Pinput(
                                  ...
                                  onCompleted: (pin) async {
                                    ...
                                    await AuthRepository.verifyMobileOtpAPI(
                                      loader: con.isLoading,
                                      mobileNumber:
                                          con.userMobileNumberWithISDCode,
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: con.isResendOtp.isFalse
                                                  ? () async {
                                                      con.isResendOtp.value =
                                                          true;

                                                      /// RESEND MOBILE OTP API
                                                      await AuthRepository
                                                          .resendOtpToMobileNumAPI(
                                                        loader: con.isResendOtp,
                                                        mobileNumber: con
                                                            .userMobileNumberWithISDCode,
                                                        onSuccess: () {
                                                          con.timerStart();
                                                        },
                                                      );
                      ...
                      children: [
                        ...
                        AnimatedContainer(
                          ...
                          child: RichText(
                            ...
                            text: TextSpan(
                              text:
                                  "By using the ${AppStrings.appName} app you agree to our\n",
                              style: Theme.of(context)
                                  .textTheme
                                  .labelLarge
                                  ?.copyWith(
                              ...
                              children: [
                                TextSpan(
                                  ...
                                  recognizer: TapGestureRecognizer()
                                    ..onTap = con.isLoading.isFalse
                                        ? () => ApiUtils.termsAndConditionsNav()
                                        : null,
                                  style: Theme.of(context)
                                      .textTheme
                                      .labelLarge
  ...
  PinTheme get defaultPinTheme {
    return PinTheme(
      ...
      decoration: BoxDecoration(
        borderRadius: borderRadius,
        border: Border.all(
            color: con.otpError.isEmpty
                ? Theme.of(Get.context!).primaryColor.withOpacity(.3)
