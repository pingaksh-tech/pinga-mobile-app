                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  paymentSummaryItem(context, title: "Delivery Charge", price: 0.0),
                                  Container(
                                    height: 1,
                                    width: Get.width,
                                  ...
                                  (defaultPadding / 1.5).verticalSpace,
                                  paymentSummaryItem(context, title: "Total Amount", price: con.totalPrice.value),
                                ],
                              ),
                            ),
                            AppButton(
    ...
    return Container(
      ...
      child: Row(
        children: [
          Text(
            "$title :",
            style: Theme.of(Get.context!).textTheme.titleMedium?.copyWith(fontSize: 13.sp, fontWeight: title == "Total Charge" ? FontWeight.w600 : FontWeight.w500),
          ),
          const Spacer(),
          Text(
            UiUtils.amountFormat(price.toString()),
            style: Theme.of(Get.context!).textTheme.titleMedium?.copyWith(fontSize: 13.sp, fontWeight: FontWeight.w600),
          ),
        ],
      ),
    );
