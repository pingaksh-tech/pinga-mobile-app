                          ...
                          return ProductTile(
                            ...
                            onTap: () {
                              ...
                              navigateToProductDetailsScreen(
                                productId: (con.cartList[index].inventoryId ?? ""),
                                ...
                                arguments: {
                                  ...
                                  'cartId': /*AppStrings.cartIdPrefixSlug +*/ (con.cartList[index].id ?? ""),
                                  "inventoryId": /*AppStrings.cartIdPrefixSlug +*/ (con.cartList[index].inventoryId ?? ""),
              ...
              bottomNavigationBar: IntrinsicHeight(
                child: AnimatedSwitcher(
                  ...
                  child: con.cartLoader.isFalse
                      ? con.cartList.isNotEmpty
                      ? Container(
                    padding: EdgeInsets.only(top: defaultPadding, bottom: MediaQuery
                        .of(context)
                        .padding
                                  ...
                                  Expanded(
                                    child: AppButton(
                                      ...
                                      titleStyle: AppTextStyle.appButtonStyle(context).copyWith(
                                        color: con.selectedList.isEmpty ? null : Theme
                                            .of(context)
                                            .colorScheme
                                            .surface,
                                      ),
