...
class CartScreen extends StatelessWidget {
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Column(
                                children: [
                                  paymentSummaryItem(context, title: "Cart items", price: "0/10"),
                                  paymentSummaryItem(context, title: "Cart quantity", price: "0/1185"),
                                  paymentSummaryItem(context, title: "Cart amount", price: "${UiUtils.amountFormat("0", decimalDigits: 0)} / ${UiUtils.amountFormat("300215", decimalDigits: 0)}"),
                                  const Row(
                                    children: [],
                                  )
                                ],
  ...
  Widget paymentSummaryItem(BuildContext context, {required String title, required String price, bool highlight = false}) {
    return Container(
