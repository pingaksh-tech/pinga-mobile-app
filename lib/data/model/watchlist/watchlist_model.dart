...
class WatchlistModel {
  ...
  factory WatchlistModel.fromJson(Map<String, dynamic> json) => WatchlistModel(
        ...
        watchLists: json["watchLists"] == null ? [] : List<WatchList>.from(json["watchLists"]!.map((x) => WatchList.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "watchLists": watchLists == null ? [] : List<dynamic>.from(watchLists!.map((x) => x.toJson())),
      };
}
...
class WatchList {
  ...
  factory WatchList.fromJson(Map<String, dynamic> json) => WatchList(
        ...
        status: json["status"],
        watchlistItems: json["watchlistItems"] == null ? [] : List<WatchlistItemModel>.from(json["watchlistItems"]!.map((x) => WatchlistItemModel.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "status": status,
        "watchlistItems": watchlistItems == null ? [] : List<dynamic>.from(watchlistItems!.map((x) => x.toJson())),
...
class WatchlistItemModel {
  ...
  factory WatchlistItemModel.fromJson(Map<String, dynamic> json) => WatchlistItemModel(
        id: json["_id"],
        sizeId: json["size_id"],
